...
As a civil society organizatoin, a part of our income from every project is donated to other civil society organizations - schools, health organizations, other civil society organizations etc." />
                ...
                <a href="http://www.hgk.hr/en" class="sponsor-logo"><img class="silver-sponsor-logo-image" src="<?php bloginfo('template_url');?>/sponsors/hgk-text-logo.png" alt="HGK logo" title="Croatian Chamber of Economy" /></a>
            </div>
        </div>
        ...
        <div class="sponsor-row">
            <div class="sponsor-container">
                <a href="http://www.netokracija.hr/" class="sponsor-logo media-sponsor-logo">
                ...
                <a href="http://www.bug.hr/" class="sponsor-logo media-sponsor-logo">
                    <img class="micro-sponsor-logo-image" src="<?php bloginfo('template_url');?>/sponsors/bug_logo_w250.jpg" alt="Bug logo" title="" />
                </a>
...
Kao organizacija civilnog društva, nije zaboravljen niti taj segment, te se Business Institute uključuje u brojne donatorske akcije, a odlukom Predsjednika, dio od svakog realiziranog projekta je namjenjen za pomoć društvenim organizacijama (školama, zdravstvenim organizacijama, drugim civilnim udrugama, …)." />
                ...
                <a href="http://www.hgk.hr/" class="sponsor-logo"><img class="silver-sponsor-logo-image" src="<?php bloginfo('template_url');?>/sponsors/hgk-text-logo.png" alt="HGK logo" title="Hrvatska gospodarska komora" /></a>
            </div>
        </div>
