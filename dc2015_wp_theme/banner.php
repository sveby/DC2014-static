...
?>
    ...
    <div class="img_main">
        ...
        <div class="panel">
            <div class="sub_panel">
                <div class="info info1">
                    <a target="_blank" class="scroll w">
        ...
        <div class="img_main">
            ...
            <div class="pos_sponsor sponsor">
                <div class="pos_sponsor_overlay">
                    ...
                    <div class="pos_sponsor n_txt f13 w">Želite se povezati s korisnicima ili predstaviti zajednici?<br>DORS/CLUC je idealno mjesto za to!</div>
        ...
        <div class="panel">
            <div class="sub_panel">
                <div class="info info1">
                    <a href="http://2015.dorscluc.org/hr/predavaci/" target="_blank" class="scroll w">
